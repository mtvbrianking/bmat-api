...
class ResetPasswordControllerTest extends TestCase
{
     ...
     * @group passing
     */
    public function cant_visit_reset_password_when_authenticated()
    {
     ...
     * @group passing
     */
    public function can_visit_reset_password_when_unauthenticated()
    {
        $user = factory(User::class)->create();
     ...
     * @group passing
     */
    public function cant_reset_password_with_invalid_token()
    {
        $user = factory(User::class)->create([
     ...
     * @group passing
     */
    public function cant_reset_password_with_invalid_email()
    {
        $user = factory(User::class)->create([
            'password' => Hash::make('old-password'),
        ]);
     ...
     * @group passing
     */
    public function cant_reset_password_with_invalid_password()
    {
        $user = factory(User::class)->create([
            'password' => Hash::make('old-password'),
        ]);
